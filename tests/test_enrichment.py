"""
Automated Pytest for echo-hemodynamic-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    DiastolicEngine,
    PulmonaryEngine,
    IntraoperativeEngine,
    EchoEngine,
    EchohemodynamicagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = EchohemodynamicagentEnrichmentSuite()
